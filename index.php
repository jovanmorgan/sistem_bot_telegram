                            ...
                            <div class="card shadow-sm mb-3">
                                <div class="card-body">
                                    ...
                                    #autoTerminal {
                                        ...
                                        box-shadow:
                                            0 0 10px #00ff00aa inset,
                                            0 0 15px #00ff00aa inset,
                                            0 0 25px #00ff0022;
                                    }
                                    ...
                                    .term-line {
                                        color: #0aff63;
                                        text-shadow: 0 0 5px #0aff63;
                                    }

                                    /* ------- CUSTOM SCROLLBAR ------- */
                                    #autoTerminal::-webkit-scrollbar {
                                        width: 10px;
                                    }

                                    #autoTerminal::-webkit-scrollbar-track {
                                        background: #001b0d;
                                        border-radius: 10px;
                                    }

                                    #autoTerminal::-webkit-scrollbar-thumb {
                                        background: #00ff6e;
                                        border-radius: 10px;
                                        box-shadow: 0 0 10px #00ff6e;
                                    }

                                    #autoTerminal::-webkit-scrollbar-thumb:hover {
                                        background: #00cc55;
                                    }
                                    </style>
